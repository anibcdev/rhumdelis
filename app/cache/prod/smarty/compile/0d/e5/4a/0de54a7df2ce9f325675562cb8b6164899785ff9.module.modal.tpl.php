<?php /* Smarty version Smarty-3.1.19, created on 2022-09-14 12:12:29
         compiled from "module:ps_shoppingcart/modal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10699354616321a90d05ff14-62838908%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10699354616321a90d05ff14-62838908',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6321a90d06ca48_66827994',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6321a90d06ca48_66827994')) {function content_6321a90d06ca48_66827994($_smarty_tpl) {?>
...
?>
				  <?php if ($_smarty_tpl->tpl_vars['property_value']->value=='Non') {?><?php } else { ?>*<?php }?>
                <?php } ?>--></p>
...
$_smarty_tpl->tpl_vars["property_value"]->_loop = true;
 $_smarty_tpl->tpl_vars["property"]->value = $_smarty_tpl->tpl_vars["property_value"]->key;
?>
				  <?php if ($_smarty_tpl->tpl_vars['property_value']->value=='Non') {?><?php } else { ?><p>*dont une gravure artisanale sur cette bouteille ( 8 € TTC)</p><br><?php }?>
                <?php } ?>-->
          ...
          </div><!-- HACK WOOPLEE style="display:none" -->
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <?php }?>
              <p><strong><?php echo smartyTranslate(array('s'=>'Total produits (hors frais de port)','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
 </strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['products']['value'], ENT_QUOTES, 'UTF-8');?>
</p>
              <p style="display:none"><strong><?php echo smartyTranslate(array('s'=>'Total shipping:','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayCheckoutSubtotalDetails','subtotal'=>$_smarty_tpl->tpl_vars['cart']->value['subtotals']['shipping']),$_smarty_tpl);?>
              ...
              <?php if ($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']) {?>
              	<p style="display:none"><strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']['label'], ENT_QUOTES, 'UTF-8');?>
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']['value'], ENT_QUOTES, 'UTF-8');?>
</p>
              <?php }?>
              <p style="display:none"><strong><?php echo smartyTranslate(array('s'=>'Total:','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
