...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'You may unsubscribe at any moment. For that purpose, please find our contact info in the legal notice.' => 'Votre adresse email est uniquement utilisée par la SARL RHUMAMINA pour vous envoyer la newsletter. Vous pouvez vous désinscrire à tout moment en cliquant sur le lien de désinscription figurant en bas de celle-ci. Pour plus d’informations sur le traitement de vos données personnelles par la SARL RHUMAMINA, veuillez consulter notre politique de confidentialité́ disponible sur notre site internet à l’adresse suivante : https://rhumdelis.com/content/3-rgpd ',
