...
{block name='step_content'}
  <div id="hook-display-before-carrier">
    {$hookDisplayBeforeCarrier nofilter}
	 ...
	 <p>Délais et tarifs indicatifs pour une livraison en France métropolitaine.</p>
      ...
      >
        <div class="form-fields">
          ...
          <div class="order-options">
			  {if $gift.allowed}
              <span class="custom-checkbox checkgift"><img src="gift-box.png" width="50" height="50" alt="Papier cadeau" title="Demandez un emballage cadeau">
                <input class="js-gift-checkbox" id="input_gift" name="gift" type="checkbox" value="1" {if $gift.isGift}checked="checked"{/if}>
                <!--HACK WOOPLEE <span><i class="material-icons checkbox-checked">&#xE5CA;</i></span>-->
                <label for="input_gift">{$gift.label}</label >
              </span>

              <div id="gift" class="collapse{if $gift.isGift} in{/if}">
                <label for="gift_message">{l s='If you\'d like, you can add a note to the gift:' d='Shop.Theme.Checkout'}</label><!-- HACK WOOPLEE -->
				  <div style="display:none"><textarea rows="2" cols="120" id="gift_message" name="gift_message">-</textarea></div>
				  <textarea rows="2" cols="120" id="gift_message" name="gift_message">Je souhaite emballer : {$gift.message}</textarea>
              </div>
            {/if}
            <div id="delivery">
