				...
				{foreach from=$MR_histories key=num_history item=history}
					<tr id="detailHistory_{$history.order|intval}">
						...
						<td id="URLA4_{$history.order|intval}">
							<a href="{$history.url_a4|escape:'htmlall':'UTF-8'}" target="a4"><img width="20" src="{$new_base_dir|escape:'htmlall':'UTF-8'}views/img/pdf_icon.jpg" /></a>
						</td>
						<td id="URLA5_{$history.order|intval}">
							<a href="{$history.url_a5|escape:'htmlall':'UTF-8'}" target="a5"><img width="20" src="{$new_base_dir|escape:'htmlall':'UTF-8'}views/img/pdf_icon.jpg" /></a>
						</td>
						<td id="URL10x15_{$history.order|intval}">
							<a href="{$history.url_10x15|escape:'htmlall':'UTF-8'}" target="10x15"><img width="20" src="{$new_base_dir|escape:'htmlall':'UTF-8'}views/img/pdf_icon.jpg" /></a>
						</td>
					</tr>
				{/foreach}
				</tbody>
		...
		{/if}
			<div class="PS_MRSubmitButton" {if !$MR_histories|count}style="display:none;"{/if}>
				...
				<div class="PS_MRLoader" id="PS_MRSubmitDeleteHistoriesLoader">
					<img src="{$new_base_dir|escape:'htmlall':'UTF-8'}views/img/getTickets.gif"
				</div>
			</div>
		</form>
	</div>
