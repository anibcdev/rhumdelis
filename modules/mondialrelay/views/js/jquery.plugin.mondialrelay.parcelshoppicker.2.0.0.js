    ...
    var private = {
        ...
        MR_BuildparcelShopDetails: function (PRI) {
            var content = '<div class="InfoWindow">'
						...
						+ '<div class="Tabs-Btns">'
						+ '<span class="Tabs-Btn Tabs-Btn-Selected" id="btn_01" onclick="$(\'.fancybox-inner #' + private.containerId + '\').trigger(\'TabSelect\',\'01\');">Info</span>'
						+ '<span class="Tabs-Btn" id="btn_02" onclick="$(\'.fancybox-inner #' + private.containerId + '\').trigger(\'TabSelect\',\'02\');">Photo</span>'
						+ '</div>'
						+ '<div class="Tabs-Tabs">'
