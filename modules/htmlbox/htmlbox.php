...
class htmlbox extends Module {
	...
	public function displayForm(){
            ...
            if ($this->psversion()==5 || $this->psversion()==7){
			$form.='
		...
		foreach ($array['hook'] as $key=>$value){
            ...
            if ($this->psversion()==7){if ($key=="htmlbox_top_column"){$place=$this->l("top Column");}}
            if ($this->psversion()==7){if ($key=="htmlbox_nav"){$place=$this->l("display Nav");}}
...
text-shadow: 0 1px 0 rgba(255,255,255, .9);">'.$this->l('Off').'</span>
    ...
    public function getsettingsofhtmlbox(){
        ...
        if ($this->psversion()==7){$array['hook']['htmlbox_top_column']= Configuration::get('htmlbox_top_column');}
        if ($this->psversion()==7){$array['hook']['htmlbox_nav']= Configuration::get('htmlbox_nav');}
