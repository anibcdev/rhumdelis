...
//    safari,pagebreak,style,table,advimage,advlink,inlinepopups,media,contextmenu,paste,fullscreen,xhtmlxtras,preview
	default_config = {
		...
		extended_valid_elements: 'pre[*],script[*],style[*],section[*],iframe[*]', 
        valid_children: "+body[meta|style|script|section|iframe],pre[section|iframe|script|div|p|br|span|img|style|h1|h2|h3|h4|h5],*[*]",
        valid_elements : '*[*]', 
