<link rel="stylesheet" href="{$ever_baseUrl}modules/everpopup/views/css/everpopup.css" type="text/css" media="all">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.1.20/jquery.fancybox.min.css" />
<script type="text/javascript" src="{$ever_baseUrl}modules/everpopup/views/js/jquery.fancybox.min.js"></script>
<script type="text/javascript" src="{$ever_baseUrl}modules/everpopup/views/js/everpopup.js" ></script>
...
<div id="Everpopup_block_center" class="Everpopup_block" style="display:none;"><div id="fenzy">
	...
	{if $everpopup->ever_paragraph}<div class="rte">{$everpopup->ever_paragraph nofilter}</div>{/if}
