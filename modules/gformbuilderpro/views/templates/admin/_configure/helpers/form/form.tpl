                    ...
                    {if isset($fields_value['extra']['html']) && $fields_value['extra']['html']}
                        {foreach $fields_value['extra']['html'] as $html}
                            <div class="product-pack-item media-product-pack" data-product-name="{$html.name|escape:'html':'UTF-8'}" data-product-id="{$html.id|escape:'html':'UTF-8'}">
                                {if isset($fields_value['loadjqueryselect2']) && $fields_value['loadjqueryselect2'] == '1'}
                                    <img class="media-product-pack-img" src="{$html.image_link|escape:'html':'UTF-8'}"/>
                                {/if}
                                <span class="media-product-pack-title">{$html.name|escape:'html':'UTF-8'}</span>
        ...
        <div class="col-lg-9">
            <div class="panel">
                <div class="multival_box" id="multival_{$input.name|escape:'html':'UTF-8'}" rel="{$input.name|escape:'html':'UTF-8'}">
                    ...
                    {*}
                    {else}
                        <input type="hidden" id="{$input.name|escape:'html':'UTF-8'}" name="{$input.name|escape:'html':'UTF-8'}" value="" />
                    {/if}{*}
                </div>
            </div>
