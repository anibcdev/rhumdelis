...
class Productfield
{
    public  function getInfo()
	{
		return array(
                ...
                'desc' => $this->l('../modules/gformbuilderpro/views/img/product.png'),
                'possition' =>10
                );
	}
	   ...
	   $label_pos = array(
		...
		$inputs = array(
            ...
            array(
                ...
                'id' => 'extra',
				'label' => $this->l('Product'),
                'desc' => $this->l('Search product, select product then click to button "Add"'),
                'class'=>'select_value',
                'required'=>true
			),
            array(
            ...
            array(
                ...
                'name' => 'multi',
                'required' => false,
                'desc' => $this->l('If on, then front-end user can select multi product.'),
                'is_bool' => true,
                'values' => array(array(
                        'id' => 'multi_on',
                        'value' => 1,
