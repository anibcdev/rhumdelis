...
class Colorchoosefield
{
    public  function getInfo()
	{
		return array(
                'label' => $this->l('Color Box'),
                'desc' => $this->l('../modules/gformbuilderpro/views/img/colorchoose.png'),
                'possition' =>6
                );
	}
	   ...
	   $label_pos = array(
		...
		$inputs = array(
            ...
            array(
                ...
                'name' => 'multi',
                'required' => false,
                'desc' => $this->l('If on, then front-end user can choose multi value.'),
                'is_bool' => true,
                'values' => array(array(
                        'id' => 'multi_on',
                        'value' => 1,
