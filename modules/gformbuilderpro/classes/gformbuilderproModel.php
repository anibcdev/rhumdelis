...
class gformbuilderproModel extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'sendto'  =>  array('type' => self::TYPE_STRING,'required' => true,'validate' => 'isString'),
            ...
            'submittitle'=>  array('type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'required' => true, 'size' => 255),
    ...
    public function parseTpl($id_lang,$id_shop){
        ...
        $fields_value = array(
            ...
            'submittitle'=>$this->submittitle[$id_lang]
        );
    ...
    public function parseEmail($lang,$filename,$sender = false){
        ...
        if($sender)
            $fields_value = array(
                ...
                'emailcontent'=>$this->emailtemplatesender[$lang['id_lang']],
            );
        else
            $fields_value = array(
                'subject'=>$this->subject[$lang['id_lang']],
                'emailcontent'=>$this->emailtemplate[$lang['id_lang']],
            );
        Context::getContext()->smarty->assign($fields_value);
