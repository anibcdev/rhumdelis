...
<thead>
  <tr>
    <th>{l s='Customer group' mod='systempay'}</th>
    <th>{l s='Minimum amount' mod='systempay'}</th>
    {if !isset($min_only) || !$min_only}<th>{l s='Maximum amount' mod='systempay'}</th>{/if}
  </tr>
</thead>

<tbody>
  <tr style="background-color: #bebebe;">
    <td>{l s='ALL GROUPS' mod='systempay'}</td>
    <td>
