...
class SystempayOneyPayment extends AbstractSystempayPayment
{
    const ONEY_THREE_TIMES_MAX_FEES = 10;
    const ONEY_FOUR_TIMES_MAX_FEES = 20;

    protected $prefix = 'SYSTEMPAY_ONEY_';
    ...
    public function isAvailable($cart)
    {
        ...
        if (!SystempayTools::checkOneyRequirements($cart)) {
            return false;
        }
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('SYSTEMPAY_ONEY_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['systempay_oney_options'] = $options;
