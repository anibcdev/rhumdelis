...
class SystempayMultiPayment extends AbstractSystempayPayment
{
    protected $prefix = 'SYSTEMPAY_MULTI_';
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['systempay_multi_options'] = self::getAvailableOptions($cart);

        $entry_mode = Configuration::get($this->prefix.'CARD_MODE');
        $vars['systempay_multi_card_mode'] = $entry_mode;
    ...
    {
        $all_cards = SystempayTools::getSupportedMultiCardTypes();
