...
require_once 'SystempayApi.php';

if (! class_exists('SystempayResponse', false)) {

    /**
     * Class representing the result of a transaction (sent by the IPN URL or by the client return).
     */
    class SystempayResponse
    {
         ...
         * @var string
         */
        private $algo = SystempayApi::ALGO_SHA1;
        ...
        /**
         * Constructor for SystempayResponse class.
         ...
         * @param string $algo
         */
        public function __construct($params, $ctx_mode, $key_test, $key_prod, $algo = SystempayApi::ALGO_SHA1)
        {
            $this->rawResponse = SystempayApi::uncharm($params);
            $this->certificate = trim(($ctx_mode == 'PRODUCTION') ? $key_prod : $key_test);

            if (in_array($algo, SystempayApi::$SUPPORTED_ALGOS)) {
                $this->algo = $algo;
            }
        ...
        {
            return SystempayApi::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        {
            $currency = SystempayApi::findCurrencyByNumCode($this->get('currency'));
        ...
        /**
         * @deprecated Deprecated since version 1.2.1. Use <code>SystempayResponse::getLogMessage()</code>
         * or <code>SystempayResponse::getMessage()</code> instead.
         */
        ...
        /**
         * @deprecated Deprecated since version 1.2.0. Use <code>SystempayResponse::getOutputForPlatform()</code> instead.
         */
        ...
        public function getOutputForPlatform($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(Tools::strtoupper($original_encoding), SystempayApi::$SUPPORTED_ENCODINGS) ?
